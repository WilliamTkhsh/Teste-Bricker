...
class Matricula(BaseModel):
    expedition_date: str = Field(description = "a data de emissão do presente documento retorne no formato dd/MM/yyyy")
    ...
    block: Optional[str] = Field(description = "a quadra do imóvel (se houver, somente número/nome da quadra)")
    street: str = Field(description = "A primeira rua do imóvel, escrever no começo se é rua, avenida, etc")
    street_2: Optional[str] = Field(description = "A segunda rua do imóvel, escrever no começo se é rua, avenida, etc")
    property_number: Optional[str] = Field(description = "sempre que houver, pegar o primeiro número do endereço do imóvel")
    property_number_2: Optional[str] = Field(description = "sempre que houver, pegar o segundo número do endereço do imóvel")
    address_complement: Optional[str] = Field(description = "o número do apartamento, número do bloco ou número da vaga de garagem. IMPORTANTE: SOMENTE o número;")
    ...
    owner_2: Optional[str] = Field(description = "Nome Completo do segundo proprietário (se houver)")
    ...
    document_owner_2: Optional[str] = Field(description = "CPF ou CNPJ do proprietário secundário (se houver) (PADRÃO CPF: 000.000.000-00) (PADRÃO CNPJ: 00.000.000/0000-00)")
    mortgage: str = Field(description = "Indique se o imóvel está em hipoteca (sim ou não) retorne sim ou não")
    mortgage_owner_name: Optional[str] = Field(description = "Nome do dono da hipoteca (se houver)")
    mortgage_owner_document: Optional[str] = Field(description = "CPF ou CNPJ do proprietário da hipoteca (se houver)")
    ...
    fiduciary_alienation_owner_name: Optional[str] = Field(description = "Nome do dono da alienação fiduciária (se houver)")
    fiduciary_alienation_owner_document: Optional[str] = Field(description = "CPF ou CNPJ do proprietário da alienação fiduciária (se houver) (PADRÃO CPF: 000.000.000-00) (PADRÃO CNPJ: 00.000.000/0000-00)")
